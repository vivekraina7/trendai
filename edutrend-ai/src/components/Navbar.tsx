          ...
          <div className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm text-muted hover:text-primary-light hover:bg-surface-light/50 transition-all duration-200"
              >
          ...
          <div className="px-4 py-4 space-y-2">
            {navLinks.map((link) => (
              <Link
                ...
                className="flex items-center gap-2 px-3 py-2.5 rounded-lg text-muted hover:text-primary-light hover:bg-surface-light/50 transition-all"
              >
                <link.icon className="w-4 h-4" />
                {link.label}
              </Link>
